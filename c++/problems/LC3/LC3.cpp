...
Return type: None
**************************************************/
LC3::LC3() : m_R(TOTAL_GENERAL_PURPOSE_REGISTERS, 0) {
...
void LC3::step() {
	...
	this->iport->read(this->m_PC, instruction);
	this->m_PC += 1;
...
void LC3::op_trap( uint16_t instruction ) {
	...
	// Saving the return address in R7
	this->m_R[7] = this->m_PC;
